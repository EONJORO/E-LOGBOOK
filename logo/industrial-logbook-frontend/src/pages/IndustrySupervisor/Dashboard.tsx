      ...
      <main className="container py-4">
        ...
        <div className="row g-4">
          <div className="col-md-6">
            <div className="card shadow-sm text-center">
              <div className="card-body">
                <i className="bi bi-bar-chart-line fs-2 text-maroon mb-2"></i>
                <h5 className="card-title">Intern Performance Summary</h5>
          ...
          <div className="col-md-6">
            <div className="card shadow-sm text-center">
              <div className="card-body">
                <i className="bi bi-calendar-week fs-2 text-maroon mb-2"></i>
                <h5 className="card-title">Weekly Review Schedule</h5>
                <p className="card-text">--</p>
              </div>
            </div>
          </div>
        </div>
        <div className="mt-5 alert alert-info">Dashboard widgets coming soon.</div>
      </main>
    </div>
  </div>
);
