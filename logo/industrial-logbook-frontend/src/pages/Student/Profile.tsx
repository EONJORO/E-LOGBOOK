  ...
  <div className="d-flex" style={{ minHeight: "100vh" }}>
    ...
    <div className="flex-grow-1 bg-light">
      ...
      <main className="container py-4">
        <h2 className="mb-4 text-maroon">Profile</h2>
        {/* Profile info and change password form go here */}
        <div className="alert alert-info">Profile management functionality coming soon.</div>
      </main>
    </div>
  </div>
);
